...
<head>
    ...
    <title>MovieList: Categorias</title>
    ...
    <section class="sectionAll">
        ...
        <section class="section">
            <div class="divPrincipal">
                <form action="{{url('/consulta-por-categoria')}}" method="POST">
                    {{csrf_field()}}
                    <input type="text" placeholder="Pesquise pela categoria" name="txtCategoria">
                    <button type="submit" id="btn">Buscar</button>
                </form>
            </div>

            <div class="divSecundaria">
                <form action="{{url('/inserir-categoria')}}" method="POST">
                    {{csrf_field()}}
                    <input type="text" placeholder="Nome da categoria" name="categoriaTxt">
            ...
            <table class="table table-striped">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><a href="/editar-categoria-tl/{{$categoria->idCat}}"><i class="fas fa-pen"></i></a></td>
                        <td><a href="/excluir-categoria/{{$categoria->idCat}}"><i class="fas fa-trash-alt"></i></a></td>
                    <tr>
                        @endforeach
                </tbody>
            </table>
