...
<head>
    ...
    <title>MovieList: Editar categoria</title>
    ...
    <section class="sectionAll">
        ...
        <section class="section">
            <div class="divSecundaria">
                <form action="{{url('/editar-categoria')}}" method="GET">
                    {{csrf_field()}}
                        <input type="text" placeholder="Nome da categoria" value="{{ $categorias[0] -> categoria }}" name="categoriaTxt">
                       <button type="submit" id="btn2"  value="{{ $categorias[0] -> idCat }}" name="id">Editar</button>
                </form>
